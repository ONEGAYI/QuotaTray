...
export const en: Record<TextKey, string> = {
  ...
  "usage.manageCombinations": "Manage",
  ...
  "usage.manageCombinationTitle": "Manage comparisons",
  "usage.manageCombinationDesc": "Changes save immediately; close Manage and use Add combination to add another",
  "usage.modelOrWindow": "Model or quota window",
  "usage.add": "Add",
  "usage.done": "Done",
  "usage.remove": "Remove",
  "usage.autoSaved": "Auto-saved",
  "usage.limitReached": "The four-series limit is reached. Remove one in Manage first.",
  "usage.noCandidate": "No compatible combinations remain.",
  "usage.unitConflict": "The absolute axis currently uses {unit}",
  "usage.unitConflictHidden": "{count} combination(s) use an absolute unit incompatible with {unit} and are hidden. Remove or adjust them in Manage.",
  ...
  "usage.focusHint": "Select a legend item to focus its line",
