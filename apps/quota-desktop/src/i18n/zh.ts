...
export const zh = {
  ...
  "usage.settingsError": "统计设置读取失败：{msg}",
  "usage.emptyTitle": "暂无使用历史",
  "usage.statusTitle": "使用统计",
  "usage.emptyHistory": "此 Provider 所选范围内没有可绘制的数据；完成一次成功查询后再回来查看。",
  ...
  "usage.addCombination": "添加组合",
  "usage.combinationCount": "{count}/4",
  "usage.addCombinationTitle": "添加比较组合",
  "usage.addCombinationDesc": "指定一个 Provider 与模型/额度窗口",
  "usage.modelOrWindow": "模型或额度窗口",
  "usage.add": "添加",
  "usage.remove": "删除",
  "usage.autoSaved": "自动保存",
  "usage.limitReached": "已达到 4 条上限；请先在「聚焦组合」中删除一个组合。",
  "usage.noCandidate": "没有可继续添加的兼容组合。",
  "usage.unitConflict": "当前绝对值轴为 {unit}",
  "usage.unitConflictHidden": "有 {count} 条组合因绝对值单位与 {unit} 不兼容，暂未显示。请在「聚焦组合」中删除或调整组合。",
  "usage.unavailable": "当前不可用",
  "usage.emptySelection": "尚未添加比较组合",
  "usage.saveFailed": "保存比较组合失败：{msg}",
  "usage.resetFocus": "清除聚焦",
  "usage.focusHint": "点击「聚焦组合」中的组合可聚焦曲线",
  "usage.legendTrigger": "聚焦组合",
  "usage.focusKicker": "FOCUSING",
  "usage.focusEmpty": "无聚焦组合",
  "usage.legendRemoveArmed": "再次点击确认删除",
  "usage.legendHint": "可单击组合聚焦/失焦；聚焦状态下「定位线」将解锁完整测量能力",
  ...
  "usage.markerPlaceHint": "点击图表放置定位线（最多 2 条，自动吸附数据点）；Esc 或再次点击退出；满两条后再点将清除两条并从头定位",
  ...
  "edit.primaryMetric": "主度量展示",
  "edit.primaryMetricAuto": "自动",
  "edit.primaryMetricPercent": "百分比",
  "edit.primaryMetricAmount": "金额",
  "edit.primaryMetricHint":
    "摘要位优先展示的度量；个别窗口数据不支持时按窗口回退，试查会提示",
  "edit.metricFallbackToAmount": "{windows}无百分比数据，将按金额显示",
  "edit.metricFallbackToPercent": "{windows}无剩余金额，将按百分比显示",
  "edit.metricFallbackClose": "关闭回退提示",
  ...
  "settings.exportModalTitle": "导出迁移包",
  "settings.exportModalDescription": "选择迁移包的加密方式",
  "settings.exportModePassword": "密码保护（推荐）",
  "settings.exportModeConvenient": "便捷",
  "settings.exportPasswordInfo": "备份密码不会被保存；忘记后迁移包无法恢复，请务必牢记。",
  "settings.exportPasswordLabel": "备份密码（至少 8 个字符）",
  "settings.exportPasswordConfirmLabel": "再次输入备份密码",
  "settings.exportPasswordTooShort": "密码至少需要 {min} 个字符",
  "settings.exportPasswordMismatch": "两次输入的密码不一致",
  "settings.exportConvenientWarning": "导出的文件携带一次性解密密钥，可恢复全部账户凭据（并含查询历史），敏感级别等同明文凭据。请仅保存到可信位置，并在迁移完成后删除。",
  "settings.exportModalConfirm": "导出",
  "settings.exportDialogTitle": "导出 QuotaTray 配置",
  "settings.exportSuccess": "配置已导出至：{path}",
  "settings.importTitle": "导入迁移包",
  "settings.importHint": "将备份中的供应商、凭据、定价与查询历史导入本机；默认合并（不丢本机数据），可选覆盖。",
  "settings.importButton": "导入迁移包",
  "settings.importing": "正在导入…",
  "settings.importModalTitle": "导入迁移包",
  "settings.importModalDescription": "选择迁移包，并决定它与本机数据的关系",
  "settings.importPickFile": "选择迁移包文件",
  "settings.importPickAnother": "重选",
  "settings.importInspecting": "正在识别文件…",
  "settings.importContainerVersion": "容器 v{version}",
  "settings.importContainerConvenientMode": "便捷档（无需密码）",
  "settings.importContainerPasswordMode": "密码档（需备份密码）",
  "settings.importPasswordLabel": "备份密码",
  "settings.importPasswordRequired": "该迁移包为密码档，请输入备份密码",
  "settings.importStrategyLabel": "导入方式",
  "settings.importStrategyMerge": "合并（推荐）",
  "settings.importStrategyOverwrite": "覆盖",
  "settings.importMergeHint": "只补充本机没有的条目与比较组合，同 id 以本机为准，不丢失本机任何数据",
  "settings.importOverwriteHint": "本机数据完全变成备份内容",
  "settings.importOverwriteWarning": "覆盖导入会先清空本机当前全部供应商、凭据、定价、自定义模型、比较组合与查询历史，再替换为备份内容。此操作不可撤销。",
  "settings.importOverwriteAck": "我了解覆盖导入会清除本机当前数据且不可撤销",
  "settings.importConfirmOverwrite": "确认覆盖导入",
  "settings.importConfirmOverwriteCountdown": "确认覆盖导入（{seconds}s）",
  "settings.importModalConfirm": "导入",
  "settings.importDialogTitle": "导入 QuotaTray 配置",
  "settings.importSuccessMerge": "合并完成：供应商新增 {providersAdded} 个、跳过 {providersSkipped} 个重复；比较组合新增 {seriesAdded} 条、跳过 {seriesSkipped} 条。",
  "settings.importSuccessOverwrite": "覆盖导入完成：已导入 {providersAdded} 个供应商、{seriesAdded} 条比较组合。",
  "settings.importSuccessMergeProviders": "合并完成：供应商新增 {providersAdded} 个、跳过 {providersSkipped} 个重复。",
  "settings.importSuccessOverwriteProviders": "覆盖导入完成：已导入 {providersAdded} 个供应商。",
  "settings.importDegradedHistory": "历史数据未写入本机（{reason}）；配置导入已成功，重新导入可恢复历史。",
  "settings.importDegradedUsageComparison": "比较组合未写入本机（{reason}）；配置导入已成功，重新导入可恢复。",
  "settings.exportDegradedHistory": "迁移包未包含历史数据（{reason}）；其余配置已导出。",
  ...
  "settings.updateProxyPortHint": "安装包下载与开启代理的条目查询经 HTTP 代理（如 Clash 填 7897）；更新检测优先直连、失败自动经代理重试；留空直连",
  ...
  "settings.catalogResultUpdated": "已更新至 revision {revision}",
  "settings.catalogResultUnchanged": "已是最新（revision {revision}）",
  "settings.catalogResultBusy": "另一更新正在进行，稍后再试",
  "settings.catalogResultFailed": "更新失败：{msg}",
  "settings.catalogScheduleOnDesktop": "自动更新已开启：应用运行期间约每 6 小时自动检查，失败后至少 30 分钟重试。",
  "settings.catalogScheduleOnMobile": "自动更新已开启：应用前台运行期间约每 6 小时自动检查（回到前台会补检），失败后至少 30 分钟重试。",
  "settings.catalogScheduleOff": "自动更新已关闭：不会自动联网检查，仍可点“立即更新”手动获取最新目录。",
