...
pub enum T {
    ...
    PricingVerifiedAt,
    PricingVerificationUnknown,
    PricingOfficialSources,
    HelpPricing,
    HelpPricingShow,
    HelpPricingShowId,
    HelpPricingShowJson,
...
fn zh(key: T) -> &'static str {
    match key {
        ...
        T::PricingVerifiedAt => "模型资料核验时间",
        T::PricingVerificationUnknown => "核验时间未知",
        T::PricingOfficialSources => "官方模型资料（不包含自定义价格）",
...
fn en(key: T) -> &'static str {
    match key {
        ...
        T::PricingVerifiedAt => "Model information verified at",
        T::PricingVerificationUnknown => "Verification date unknown",
        T::PricingOfficialSources => "Official model information (excludes custom prices)",
